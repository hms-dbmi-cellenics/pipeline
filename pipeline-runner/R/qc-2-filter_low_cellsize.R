...
filter_low_cellsize <- function(seurat_obj, config, task_name, sample_id, num_cells_to_downsample = 6000) {
  ...
  plot2_data <- unname(purrr::map2(log(numis), ranks, function(x,y) {c("log_u"=x, "rank"=y)}))
