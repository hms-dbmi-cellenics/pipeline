...
#' In case of 10x, `annot` contains a data.frame from reading the features.tsv.gz file,
#' while in rhapsody it contains the gene symbols as read from the count matrix.
#'
...
#'
#' Parses sparse count matrices generated by BD Rhapsody primary analysis pipeline.
#'
#' @inheritParams download_user_files
#' @return list containing \itemize{
#'   \item{"counts_list"}{named list of dgCMatrix per sample}
